# VirtualBox to Proxmox VM Migration
...
### Phase 2: Disk Conversion (VirtualBox → Raw Image)

**Tool:** VBoxManage (VirtualBox command-line interface)

Each `.vdi` disk must be converted to a raw `.img` format that Proxmox can import.
...
**Step 2: Import Disk Images to Proxmox**
...
**Step 5: Additional Disk Configuration (for multi-disk VMs)**
